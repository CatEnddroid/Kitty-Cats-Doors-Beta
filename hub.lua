...
Tabs.Main:AddButton({
  Title = "Mischevious Shakelight",
  Description = "An angry shakelight",
  Callback = function()
      Window:Dialog({
          Title = "Confirm?",
          Content = "Are you sure?",
...
Tabs.Main:AddButton({
  Title = "Guiding Scanner|Grassful",
...
loadstring(game:HttpGet('https://gist.githubusercontent.com/IdkMyNameLoll/8b05c837bea9effac2554340465b4be1/raw/3f3be0ee72e7f153db39a16a40fa63dce6cde72d/SpiralBottle'))()
        ...
        Tabs.Main:AddButton({
  Title = "Resize Stick|Indexell",
  Description = "Resize things Biggef Tiny",
  Callback = function()
      Window:Dialog({
          Title = "Confirm?",
          Content = "Are you sure?",
